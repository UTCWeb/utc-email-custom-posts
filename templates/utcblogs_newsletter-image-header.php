    ...
    <tr style="padding:0;text-align:left;vertical-align:top">
        <td class="center" align="center" valign="top" style="-moz-box-sizing:border-box;-moz-hyphens:auto;-webkit-box-sizing:border-box;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;box-sizing:border-box;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:1.4;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
            <center style="width:100%">
                <!-- former location of the wrapper for the default header -->
                            ...
                            <?php if (have_posts()) : ?>
                                <?php while (have_posts()) : the_post(); ?>
                                    ...
                                    <?php if ( has_post_thumbnail()) : ?>
                                        ...
                                        $newsletter_featured_header_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'newsletter-featured-header'); ?>
                                        <img src="<?php echo $newsletter_featured_header_image_url[0] ?>" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: auto; width:100%; max-width: 100%; float: left; clear: both; display: block;" align="left" />
                                    <?php else : ?>
                                        <!-- No thumbnail image -->
                                    <?php endif; ?>
